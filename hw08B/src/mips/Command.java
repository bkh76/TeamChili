...
public class Command implements Visitor<List<String>> {
    ...
    public List<String> visit(CJump com) {
        ...
        asmCode.add(Asm.label(com.getTrueLabel().toString()));
        asmCode.add(Asm.label(com.getFalseLabel().toString()));
        asmCode.add(Asm.command("beq $zero, " + com.getCondition()
         + " " + com.getTrueLabel()));
	...
	// TODO: Done?
        ...
        //TODO: I feel like there should be something else here?
        return asmCode;
    }
