...
public class TypeChecker extends ErrorList implements Visitor<Type>
{
    ...
    public Type visit(StmIf stm) {
        if (stm.condition.accept(this) != type.Type.BOOL || stm.condition.accept(this) != type.Type.INT { //we allow int flags, yes?
            errors.add("At " + stm.condition.pos + " an expression of type boolean or integer is expected."); 
        }
